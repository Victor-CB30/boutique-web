                                                    ...
                                                    <td class="admin-actions-cell">
                                                        <details class="admin-actions-menu table-actions-menu">
                                                            ...
                                                            <div class="admin-actions-dropdown"><a href="?editar=<?=$c['id_categoria']?>">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg> Editar</a>
