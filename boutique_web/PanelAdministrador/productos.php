...
$paginaActivaAdmin = 'productos';
$kickerAdmin = 'Catálogo';
$tituloSeccionAdmin = 'Gestión de productos';
$subtituloSeccionAdmin = 'Administra productos, imágenes, precios y stock desde una sola pantalla.';
$mostrarUsuarioAdmin = true;
$cajaLateralAdmin = ['titulo' => 'Catálogo', 'valor' => $totalProductos, 'nota' => 'productos registrados'];
$accesosRapidosAdmin = ['Nuevo producto' => '#form-producto', 'Ver listado' => '#tabla-productos'];
        ...
        <form method="POST" class="admin-form" enctype="multipart/form-data">
            ...
            <div class="admin-form-row">
                <label>Tallas disponibles
                    ...
                    <span class="form-helper">Separar por comas.</span>
                </label>
            ...
            <div class="admin-image-tools">
                ...
                <label class="admin-upload-tray" for="imagen_local">
                    ...
                    <span class="upload-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v12"/><path d="m7 8 5-5 5 5"/><path d="M5 21h14"/></svg>
                    </span>
            ...
            <div class="admin-form-actions">
                <button class="btn btn-primary" type="submit"><?= $productoEditar ? 'Guardar cambios' : 'Registrar producto' ?></button>
                <?php if ($productoEditar): ?><a class="btn btn-ghost" href="<?= htmlspecialchars($retornoListado) ?>">Cancelar</a><?php endif; ?>
            </div>
        </form>
    </article>
                ...
                <div class="admin-product-row">
                    ...
                    <div class="admin-product-actions" data-label="Acciones">
                        <details class="admin-actions-menu">
                            <summary aria-label="Abrir acciones del producto" title="Acciones">
                            ...
                            <div class="admin-actions-dropdown">
                                <a href="../producto_detalle.php?id=<?= (int)$producto['id_producto'] ?>" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2.062 12.348a1 1 0 0 1 0-.696C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.938 7.152a1 1 0 0 1 0 .696C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.938-7.152Z"/><circle cx="12" cy="12" r="3"/></svg>
                                    Ver producto
                                </a>
